...
if (process.argv.length <= 5) { 
	console.log("Usage: node light.js <URL> <PROXIES> <USERAGENT> <TIME> <GET/HEAD/POST/DELETE/PUT/RANDOM>");
	console.log("Non Spoofed Variant by boss.");
	process.exit(-1);
}
...
const proxies = await fs.readFileSync(process.argv[3], 'utf-8').replace(/\r/g, '').split('\n');
console.log(proxies)
