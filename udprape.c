...
void setup_udp_header(struct udphdr *udph)
{
    ...
    udph->check = 0;
    memcpy((void *)udph + sizeof(struct udphdr), "https://cdn.discordapp.com/attachments/937053108780032040/937148037074157618/YSZwaWQ9QXBp.png", 4);
...
int main(int argc, char *argv[ ])
{
        if(argc < 5){
                ...
                fprintf(stderr, "Developed for rain, 2021.\n");
                exit(-1);
        }
